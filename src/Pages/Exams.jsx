    ...
    <>
      ...
      <div className="flex-1 bg-gray-500 bg-opacity-40 pb-6 backdrop-blur-md min-h-screen">
        ...
        <div className="mt-4 mx-6 shadow-md rounded-lg p-3 bg-white">
          <div x-data="{ search: '' }">
            <div className="my-3 col-span-full flex w items-center justify-center">
              <label
                htmlFor="batch"
              ...
              <div className="mt-4 pl-10">
                <select
                  ...
                  className="block w-96 h-9 rounded-md border-0 py-1.5 text-gray-800 shadow-md ring-1 ring-inset ring-gray-400 focus:ring-2 focus:ring-inset  focus:text-gray-800 mr-2 sm:max-w-xs sm:text-sm sm:leading-6"
                >
